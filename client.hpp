#ifndef __AREDIS_CLIENT_HPP__
#define __AREDIS_CLIENT_HPP__
#include <hiredis/hiredis.h>
#include <hiredis/async.h>
#ifdef __AREDIS_SSL__
#include <hiredis/hiredis_ssh.h>
...
template<class derived_t,typename _Mutex>
class client:public detail::object_t<derived_t>{
public:   

    using mutex_type = _Mutex;
    using lock_guard_type = std::unique_lock<mutex_type>;
...
#include "client.void.hpp"

#endif//__AREDIS_CLIENT_HPP__
